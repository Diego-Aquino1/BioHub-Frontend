    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          ...
          <span class="mx-2 text-2xl font-semibold text-white">BIO  - HUB</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        >
          ...
          <span class="mx-4">Needleman Wunsch</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Blank2' ? activeClass : inactiveClass]"
          to="/blank2"
        >
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path
          ...
          <span class="mx-4">Comparación de Secuencias </span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Blank3' ? activeClass : inactiveClass]"
          to="/blank3"
        >
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path
          ...
          <span class="mx-4">Smith Waterman</span>
        </router-link>
